...
if __name__ == "__main__":
    ...
    # label = label / (numpy.fabs(label))
    # label = label.reshape(-1, 1)
    # point = verification_martrix[0, :size - 1]
    # point = point.reshape(1, size - 1)
    # predict_label, predict_proba = naive_bayes_gaussian(train, label, point)
    # print("point label = ")
    # print(verification_martrix[0,-1])
    # print(" predict_label = ")
    # print(predict_label[0])
    # print("predict_proba = ")
    # print(predict_proba)
